        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-8">
            ...
            >
              <Button 
                size="lg" 
                className="h-12 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-full transition-all duration-200 hover:scale-105"
              >
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="h-12 px-8 border-border hover:bg-muted/50 font-medium rounded-full transition-all duration-200"
              >
